                            ...
                            <div>
                                ...
                                <div class="relative">
                                    ...
                                    <input type="text" name="ip" required
                                        ...
                                        placeholder="Ej: 192.168.1.50 ó http://192.168.1.50:8080/video">
                                </div>
                                <p class="text-xs text-gray-500 mt-1 ml-1">
                                    Si usas celular, pega la URL completa (ej: <span
                                        class="font-mono text-indigo-500">http://192.168.1.X:8080/video</span>)
                                </p>
                            </div>
