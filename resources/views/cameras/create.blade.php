            ...
            <form method="POST" action="{{ route($prefix . 'cameras.store') }}">
                ...
                <div class="space-y-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <!-- IP -->
                        <div>
                            <label class="block text-sm font-semibold text-gray-700 mb-2">Dirección IP o URL de
                                Stream</label>
                            <div class="relative">
                                <div class="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none">
                                    <svg class="h-5 w-5 text-gray-400" fill="none" viewBox="0 0 24 24"
                            ...
                            <p class="text-xs text-gray-500 mt-1 ml-1">
                                Si usas celular: <span class="font-mono text-indigo-500">http://192.168.1.X:8080/video</span>
                            </p>
                        </div>
                        ...
                        <div>
                            ...
                            <div class="relative">
                                ...
                                <select name="status"
                                    class="w-full pl-11 pr-10 py-3 rounded-xl bg-gray-50 border border-gray-200 focus:bg-white focus:border-indigo-500 focus:ring-4 focus:ring-indigo-500/10 transition-all outline-none text-gray-700 appearance-none cursor-pointer">
                    ...
                    {{-- ASIGNAR DUEÑO (ADMIN Y MANTENIMIENTO) --}}
                    @if(($userRole === 'admin' || $userRole === 'mantenimiento') && isset($users))
                        <div class="pt-4 border-t border-gray-100">
                            ...
                            <p class="text-xs text-gray-500 mt-1">Selecciona al usuario responsable de esta cámara.</p>
                        </div>
                    @endif
